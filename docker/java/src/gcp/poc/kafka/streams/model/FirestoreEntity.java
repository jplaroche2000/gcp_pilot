...
public abstract class FirestoreEntity {
	...
	public abstract Key getKey(Datastore datastore);

	public abstract Entity updatedEntity(Datastore datastore);
	
	public abstract Entity newEntity(Datastore datastore);
